				<article class="post post_<?php echo $item->intendedTemplate(); ?><?php if ($item->isVisible() != true ) { echo ' post_draft'; } ?>" itemscope itemtype="http://schema.org/BlogPosting">
					<header class="post-header">
						...
						<div class="post-categories">
							...
							<span class="post-category-item"><a class="post-category-link" href="<?php echo "/category:" . $category; ?>"><?php echo c::get('categories.' . $category); ?></a></span>
							<?php endif; ?>
							<?php endforeach; ?>
							<?php else: ?>
					...
					<div class="post-body" itemprop="articleBody">
						...
						<figure>
							<blockquote>
								...
								<figcaption>—<a href="<?php echo $item->source_url(); ?>"><?php echo $item->source_name(); ?></a></figcaption> 
