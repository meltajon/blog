...
<!-- Stylesheets -->
<link rel="stylesheet" media="all" href="/assets/A03/style.php/normalize.scss" />
<link rel="stylesheet" media="all" href="/assets/A03/style.php/style.scss" />
<link rel="stylesheet" media="all" href="/assets/A03/style.php/module-categories.scss" />
<link rel="stylesheet" media="all" href="/assets/A03/style.php/module-post.scss" />
<?php
$template_css_url = "assets/A03/template-" . $page->template() . ".scss";
if (file_exists($template_css_url)) { ?>
<link rel="stylesheet" media="all" href="<?php echo "/assets/A03/style.php/template-" . $page->template() . ".scss"; ?>" />
<?php } ?>
