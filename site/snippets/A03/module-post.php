				<article class="post post_<?php echo $item->intendedTemplate() ?>">
					...
					<footer class="post-footer">
						...
						<?php if ($isListing = false): ?>
						<div class="related-posts">
							<h2 class="related-posts-title">Related Posts</h2>
							<ul class="related-posts-list">
								<?php foreach(page('tech')->children()->visible()->flip()->limit(5) as $item) { ?>
								<li class="home-item">
									<a class="post-permalink" href="<?php echo $item->url(); ?>" rel="bookmark"><?php echo html($item->title()) ?></a>
								</li>
								<? } ?>
							</ul>
						</div><!-- related-posts -->
