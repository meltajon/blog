...
<!-- Stylesheets -->
<link rel="stylesheet" media="all" href="/assets/A02/style.php/normalize.scss" />
<link rel="stylesheet" media="all" href="/assets/A02/style.php/style.scss" />
<link rel="stylesheet" media="all" href="/assets/A02/style.php/module-categories.scss" />
<link rel="stylesheet" media="all" href="/assets/A02/style.php/module-post.scss" />
<?php
$template_css_url = "assets/A02/template-" . $page->template() . ".scss";
if (file_exists($template_css_url)) { ?>
<link rel="stylesheet" media="all" href="<?php echo "/assets/A02/style.php/template-" . $page->template() . ".scss"; ?>" />
<?php } ?>
...
<script type="text/javascript" src="/assets/A02/smooth-page-scroll.js"></script>
...
<body>
	...
	<header id="header">
		<div id="header-wrapper" class="wrapper">
			...
			<nav id="main-nav">
				<a class="main-nav-item" href="#menu" >Main Menu</a>
				<?php if (c::get('is_personal', false) == true): ?>
				<a class="main-nav-item" href="/personal" >Personal</a>
				<a class="main-nav-item" href="/friends" >Friends</a>
				<?php else: ?>
				<a class="main-nav-item" href="https://about.me/meltajon" >About</a>
				<?php endif; ?>
				<a class="main-nav-item main-nav-item_active" href="/tech" >Tech</a>
				<a class="main-nav-item" href="/design" >Design</a>
				<a class="main-nav-item" href="/wisdom" >Wisdom</a>
				<?php if (c::get('is_personal', false) != true): ?>
				<a class="main-nav-item" href="https://twitter.com/meltajon" >Twitter</a>
				<?php endif; ?>
			</nav><!-- nav -->
		</div><!-- wrapper -->
	</header>
